...
async function create_entries() {
    ...
    await database.CertificateType.create({ name: 'Course Deregistration', created_by: '106117063' })
    await database.CertificateType.create({ name: 'Coure Re-Registration', created_by: '106117063' })
